...
/// Incluye fuentes embebidas para evitar “PDF en blanco” en mobile.
    ...
    pw.Page(
      ...
      build: (context) {
        return pw.Column(
          ...
          children: [
            pw.Text('Nido Mozzarella — Juego Kawaii',
                style: pw.TextStyle(font: fontBold, fontSize: 22)),
            pw.SizedBox(height: 8),
            pw.Text(
              'Gestioná pedidos, stock y conversión. Cada nivel enseña un concepto de negocios digitales.',
              style: pw.TextStyle(font: fontRegular, fontSize: 12),
            ),
            pw.SizedBox(height: 16),
            pw.Bullet(text: 'Nivel 1: Pedidos y desperdicio', style: pw.TextStyle(font: fontRegular)),
            pw.Bullet(text: 'Nivel 2: Métricas (puntaje, racha)', style: pw.TextStyle(font: fontRegular)),
            pw.Bullet(text: 'Nivel 3: Inventario y vencimientos', style: pw.TextStyle(font: fontRegular)),
            pw.Bullet(text: 'Nivel 4: Predicción (regresión logística)', style: pw.TextStyle(font: fontRegular)),
            ...
            pw.Container(
              ...
              child: pw.Text(
                'Tip: en mobile usá “Compartir” y abrí con Adobe/Xodo si tu visor nativo no muestra el PDF.',
